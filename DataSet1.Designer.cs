...
namespace m4_template {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class SalesDataTable : global::System.Data.TypedTableBase<SalesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SalesRow AddSalesRow(int employee_id, int customer_id, decimal sale_total, decimal vat_total, System.DateTime date, System.TimeSpan time, decimal total, decimal discount, decimal grand_total) {
            ...
            private void InitClass() {
                ...
                this.columnvat_total.AllowDBNull = false;
        ...
        public partial class SalesRow : global::System.Data.DataRow {
            ...
            public decimal vat_total {
                get {
                    return ((decimal)(this[this.tableSales.vat_totalColumn]));
                }
                set {
                    this[this.tableSales.vat_totalColumn] = value;
                }
            }
            ...
            public decimal grand_total {
                get {
                    return ((decimal)(this[this.tableSales.grand_totalColumn]));
                }
                set {
...
namespace m4_template.DataSet1TableAdapters {
    ...
    public partial class SalesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Sales] WHERE (([sale_id] = @Original_sale_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Sales] ([employee_id], [customer_id], [sale_total], [vat_total], [da" +
                "te], [time], [total], [discount], [grand_total]) VALUES (@employee_id, @customer" +
                "_id, @sale_total, @vat_total, @date, @time, @total, @discount, @grand_total)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@vat_total", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "vat_total", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Sales] SET [employee_id] = @employee_id, [customer_id] = @customer_id, [sale_total] = @sale_total, [vat_total] = @vat_total, [date] = @date, [time] = @time, [total] = @total, [discount] = @discount, [grand_total] = @grand_total WHERE (([sale_id] = @Original_sale_id))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@vat_total", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "vat_total", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["GroupPmb14ConnectionString"].ConnectionString;
        }
        ...
        public virtual int Insert(int employee_id, int customer_id, decimal sale_total, decimal vat_total, System.DateTime date, System.TimeSpan time, decimal total, decimal discount, decimal grand_total) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((decimal)(vat_total));
        ...
        public virtual int Update(int employee_id, int customer_id, decimal sale_total, decimal vat_total, System.DateTime date, System.TimeSpan time, decimal total, decimal discount, decimal grand_total, int Original_sale_id) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((decimal)(vat_total));
